...
-- =============================================================================
-- The existing projects table uses `project_name` column (not `name`) and
-- stores the GC/customer inside `notes` with a "Customer: XXX\n" prefix
-- (see projects.html toCloudProject helper for the convention).
-- short_code is added by the ALTER above and is the conflict key.
...
INSERT INTO projects (project_name, short_code, address, status, notes) VALUES
  ('26 West 9th Street',                  '26W',   '26 West 9th Street, New York, NY 10011',                                'active', E'Customer: Alexander Wolf and Son'),
  ('Brooklyn Conservatory of Music',      'BCM',   '1 Prospect Park West, Brooklyn, New York 11215',                        'active', E'Customer: Consigli\nCrew: Foreman Manuel Cruz; Mech: Santos, Giovanny\nNeed: Starting 4/27 add 4 pipefitters for 3 weeks'),
  ('CENTRALE - 89 E 42ND STREET',         'CGCS',  '89 East 42nd Street, New York, New York 10017',                         'active', E'Customer: Vanguard Construction\nCrew: Joseph Taylor, Maximo\nNeed: starting 4/27 or 4/28, add 4 pipefitters for 3 weeks'),
  ('I.M.L Culture Fly',                   'CFP',   '48 West 37th Street 12th & 13th Floors, New York, NY 10018',            'active', E'Customer: Precision Building & Consulting, LLC\nNeed to confirm with PM Chris what is left and duration'),
  ('Dante Restaurant',                    'DR',    '210 Elizabeth Street, New York, New York 10012',                        'active', E'Customer: Streamline USA\nNeed crew to complete wiring and Start-up: 2-3 days duration'),
  ('DBI Commercial Whitebox',             'DBI',   '19 East 88th Street, New York, New York 10128',                         'active', E'Customer: Nucor Construction\nCrew: Mech Farhod, Faridun\nNeed: install piping - 2 pipefitters for 6-7 days'),
  ('Flight Club - 31 Union Sq West',      'FC',    '31 Union Square West, New York, New York 10003',                        'active', E'Customer: Streamline USA\nCrew: Foreman Seva; Duct mech Sergii, Pradeep, Firdavs\nNeed: push piping install - 2 additional pipefitters'),
  ('Greenspace Self Storage Milltown',    'MINJ',  '142 Ryders Lane, Milltown, New Jersey 8850',                            'active', E'Customer: ELS Construction\nAndrei to confirm what is left and duration'),
  ('India Pentecostal Assembly Church',   'IPA',   '310 South Oyster Bay Rd, Syosset, New York 11791',                      'active', E'Customer: West Rac Contracting Corp\nCrew: Ductwork sub JM Haley; Piping Ruslan A., Viktor\nNeed another 3-4 days'),
  ('JM 370 7th Ave 4th Floor - 7 Penn Plaza', '7PP', '7 Penn Plaza 4th Floor, New York, New York 10001',                    'active', E'Customer: AFIAA\nConfirm with PM Chris what is left and duration'),
  ('Paramount Group Altaris',             'PG',    '31 West 52nd Street, New York, NY 10019',                               'active', E'Customer: L&K Partners\nConfirm with PM Whitney what is left and duration'),
  ('MATLOFF Greenhouse',                  'GH',    '377 West 11th Street, New York, New York 10014',                        'active', E'Customer: QBG\nConfirm with PM Whitney what is left and duration'),
  ('LA Fitness Eastchester Road',         'LAFB',  '1776 Eastchester Road, Bronx, New York 10461',                          'active', E'Customer: Donnelly Construction\nCrew: Jose Ortega, Wilson Guarchar\nConfirm with PM Chris'),
  ('Matchaful (350 Greenwich Street)',    'MT',    '350 Greenwich St, New York, New York 10013',                            'active', E'Customer: Folor\nSub: ADLS (Jason)\nConfirm with PM Chris'),
  ('Story Cannabis',                      'SCH',   '51-53 14th Street, Hoboken, New Jersey 07030',                          'active', E'Customer: Construction One\nConfirm with PM Whitney'),
  ('Skinny Louie - Flatbush Ave',         'SLF',   '218 Flatbush Avenue, Brooklyn, New York 11217',                         'active', E'Customer: Imian Partners LLC\nCrew: Fido\nConfirm with PM Chris'),
  ('Seafarers International House',       'SIH',   '123 East 15th Street, New York, New York 10003',                        'active', E'Customer: L&K Partners\nCrew: Antonio\nConfirm with Andrei'),
  ('Sadhu Vaswani Center',                'SVC',   '110 Ryders Lane East Brunswick, New Jersey 08816',                      'active', E'Customer: Sachi Group LLC\nSub: Atlantic Air (Anwar)\nNot started yet, confirm with PM Whitney'),
  ('Queens Public Library',               'QPL',   '95-15 Horace Harding Expwy, Corona, New York 11368',                    'active', E'Customer: Clune Construction\nPiping: Jean, Jesus; Ductwork sub: Master Precision\nConfirm with Whitney'),
  ('Pura Vida 5th Avenue',                'PVM',   '100 5th Avenue, New York, New York 10011',                              'active', E'Customer: JRM\nPiping/Wiring/Start-up: Vova and Maxim for next 2 days'),
  ('NY Endovascular Center / American Endo', 'EVC', '505 East 116th Street 4th Floor, New York, New York 10019',            'active', E'Customer: Eastman Cooke\nSub: ADLS (Jason)\nConfirm with PM Chris'),
  ('Yeshiva University',                  'YU',    '2495 Amsterdam Avenue, New York, New York 10033',                       'active', E'Customer: Vanguard Construction\nConfirm with Andrei'),
  ('Saddle River Day School',             'SRDS',  '147 Chestnut Ridge Rd, Saddle River, New Jersey 07458',                 'active', E'Customer: March Construction\nWiring/Piping: Alberto; BMS sub: AME\nConfirm with Andrei'),
  ('Tesla Brooklyn Maintenance',          'TBM',   'Tesla Brooklyn, New York',                                              'active', E'Customer: Autobuilders General Contracting\nConfirm with Andrei'),
  ('Warby Parker - Port Chester',         'WPPC',  '526 Boston Post Road, Port Chester, New York 10573',                    'active', E'Customer: Horizon Retail Construction\nSchedule Testing and Balancing - PM Whitney'),
  ('RA Cohen',                            'RACL',  '2 Overhill Road, Scarsdale, New York 10583',                            'active', E'Customer: GTL Construction LLC\nSub: Master Precision (Luis)\nConfirm with PM Whitney'),
  ('J-Crew Marlboro Plaza',               'JCMP',  '144 US-9, Englishtown, New Jersey 07726',                               'active', E'Customer: Planit Construction USA\nSub: Atlantic Air (Anwar)\nConfirm with Andrei'),
  ('K9 Resort',                           'K9R',   '295 Front Street, Brooklyn, New York 11201',                            'active', E'Customer: Gibian LLC\nSub: Master Precision (Luis)\nNot started yet, confirm with PM Chris'),
  ('SOMPO 2nd & 3rd Floors',              'SOMPO', '1001 Franklin Ave. Garden City, NY 11503',                              'active', E'Customer: Clune Construction\nSub: ADLS (Jason)\n4/28 or 4/29 need 2 pipefitters for 3-4 days'),
  ('Citizen Belmont Park',                'CBP',   '2501 Hempstead Turnpike, Elmont, NY 11003',                             'active', E'Customer: Folor\nNot started yet, confirm with PM Chris'),
  ('ACNE Studio Meatpacking',             'ASG',   '82 Ganservoort St, New York, NY 10014',                                 'active', E'Customer: Folor\nNot started yet, confirm with PM Chris'),
  ('American Red Cross',                  'ARC',   '520 West 49th Street, New York, NY 10019',                              'active', E'Customer: Russco\nNot started yet, confirm with PM Whitney'),
  ('580 Fifth Ave Suite 1100B',           'FAS',   '580 5th Ave - Suite 1100B, New York, NY 10036',                         'active', E'Customer: Vanguard\nNot started yet, confirm with PM Chris'),
  ('Strong Pilates',                      'SPT',   '88 Leonard St, New York, NY 10013',                                     'active', E'Customer: PWC Companies\nNot started yet, confirm with PM Chris'),
  ('Pura Vida (255 Vesey Street)',        'PVMVS', '255 Vesey Street, New York, NY 10282',                                  'active', E'Customer: Certified Construction\nNot started yet, confirm with PM Whitney'),
  ('645 Madison Avenue 16th Floor',       '645MAD','645 Madison Avenue, 16th Fl, New York, NY 10022',                       'active', E'Customer: Sentinel Builders\nNot started yet, confirm with PM Chris'),
  ('Centene/Fidelis Care 37-49 82nd Street', 'CFCJH', '37-49 82nd Street, Jackson Heights, NY 11372',                       'active', E'Customer: Carlyle Construction\nNot started yet, confirm with Andrei'),
  ('El Califa de Leon',                   'ECDL',  '20 West 3rd Street, New York, NY 10010',                                'active', E'Customer: Imian Partners LLC\nNeed to start disconnects/demo. Confirm with PM Whitney'),
  ('Medical Office Fitout',               'MO',    '51-18 190th Street, New York, NY',                                      'active', E'Customer: RP Brennan\nCrew: Ruslan O., Ihor O.\nConfirm with PM Chris')
